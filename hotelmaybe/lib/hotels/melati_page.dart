...
class MelatiPage extends StatefulWidget {
  const MelatiPage({super.key});

  @override
  State<MelatiPage> createState() => _MelatiPageState();
}

class _MelatiPageState extends State<MelatiPage> {
  @override
        ...
        children: [
          ...
          Padding(
            ...
            child: ClipRRect(
              ...
              child: Image.asset('assets/melmap.jpg', height: 180.0),
            ),
          ),
          Padding(
