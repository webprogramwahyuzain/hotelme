...
class HorisonPage extends StatefulWidget {
  const HorisonPage({super.key});

  @override
  State<HorisonPage> createState() => _HorisonPageState();
}

class _HorisonPageState extends State<HorisonPage> {
  @override
        ...
        children: [
          ...
          Padding(
            ...
            child: ClipRRect(
              ...
              child: Image.asset('assets/horimap.jpg', height: 180.0),
            ),
          ),
          Padding(
